...
<html>
  ...
  <body>
	...
	<div class="container-fluid frame-wrapper" id="pcont" style="height: 88%;">
        ...
        <iframe style="width: 100%;height: 100%;outline: none;border: 0;" id="contentFrame" name="contentFrame" src="frameIndex"></iframe>

    </div>
    <div class="footer">Copyright © 2017 Z X L. All rights reserved. </div>
